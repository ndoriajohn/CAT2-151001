                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="DelAuth.php?DeleteId=<?= $author['AuthorId']; ?>" onclick="return confirm('Are you sure you want to delete this author?')">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<center>
    ...
    <div class="footer">
     ...
     <!-- JavaScript to handle author deletion -->
    <script>
